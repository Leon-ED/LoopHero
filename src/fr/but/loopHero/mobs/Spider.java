...
public class Spider extends Mobs{
	...
	public Spider(Cell cell) {
		super("Skeleton",-1,8,3.1,0.91,new Color(41,29,33),0.45,cell,genMobsList(),10);
	}
	...
	public void draw(Graphics2D graphics, int taille) {
		...
		graphics.fillOval(startingPointx,startingPointy,taille/3,taille/3);
		
		graphics.setColor(Color.black); // Contour du mob
		graphics.drawOval(startingPointx,startingPointy,taille/3,taille/3);
